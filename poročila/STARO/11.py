...
# =============================
# FUNKCIJA: GENERIRANJE KOLEDARJA OBVEZNIH + VSEH PREDMETOV
# =============================
...
def generiraj_koledar(df_norm):
    ...
    for rok, sheetname in [("zimsko", "zimsko"), ("poletno", "poletno"), ("jesensko", "jesensko")]:
        ...
        # header: A=Predmet, B=prazno za dodatno barvo, C.. datumi
        ws.cell(row=1, column=1).value = "Predmet"
        # B1 pustimo prazno
        dates = []
        cur = start
        col_idx = 3  # datumi se začnejo v stolpcu C
        while cur <= end:
    ...
    for rok, sheetname in [("zimsko", "zimsko_vsi"), ("poletno", "poletno_vsi"), ("jesensko", "jesensko_vsi")]:
        ...
        # header: A=Predmet, datumi od B naprej
        ws.cell(row=1, column=1).value = "Predmet"
        dates = []
        cur = start
        col_idx = 2
...
# =============================
# 8. GENERIRAJ KOLEDAR OBVEZNIH + VSEH
# =============================
