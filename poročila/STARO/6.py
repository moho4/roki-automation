...
def describe_out_of_range(d: date) -> str:
    """Vrne opis, katero mejo roka datum krši."""
    if d < ZIMSKO_OD:
    ...
    # če je v katerem od intervalov, sploh ne bi smel biti 'izven', ampak vseeno vrnemo nekaj
...
if not df_predlogi.empty:
    ...
    # sortiranje: da so prekrivanja lepo skupaj
