...
# 10-dnevno pravilo po predmetu in ROKU (A: znotraj istega obdobja)
rows_10dni = []
...
# =============================
# 4. PREDLOGI NOVIH DATUMOV (TOP 5, isti rok)
# =============================
...
# odstranimo duplikate v predlogih (isti prof + predmet + datum + rok + razlog)
